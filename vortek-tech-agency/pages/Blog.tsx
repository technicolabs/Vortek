...
const Blog: React.FC = () => {
  ...
  // Simulated full content for the popup
    ...
    <div className="pt-32 pb-24 px-6 relative">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end gap-6 mb-16">
          <div>
            ...
            <p className="text-white/40 italic text-lg">"Growing knowledge in the tech forest."</p>
          </div>
                ...
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-1/3 aspect-square bg-white/5 flex items-center justify-center relative">
                    <div className="text-6xl group-hover:scale-125 transition-transform duration-700">
                      {post.category === 'Trends' ? '📈' : post.category === 'Case Studies' ? '📂' : '📖'}
                    </div>
      ...
      {selectedPost && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-8 overflow-hidden">
          ...
          <div className="relative glass w-full max-w-4xl rounded-[3rem] overflow-hidden max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-500 border-neon-green/20 custom-scrollbar shadow-2xl">
            <button 
              ...
              <header className="mb-12">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-2xl glass flex items-center justify-center text-xl border-white/10">
                    {selectedPost.category === 'Trends' ? '📈' : selectedPost.category === 'Case Studies' ? '📂' : '📖'}
                  </div>
                  <div>
