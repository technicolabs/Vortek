    ...
    <div className="pt-32 pb-24 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviews.map((r, i) => (
            <div key={i} className="glass p-12 rounded-[3rem] border-white/5 hover:border-neon-green/30 transition-all flex flex-col">
              ...
              <p className="text-white/80 text-lg italic leading-relaxed mb-10 flex-grow">"{r.text}"</p>
        ...
        <div className="mt-24 text-center">
          ...
          <a href="/#/contact" className="px-12 py-5 bg-white/5 border border-white/20 text-white font-black font-orbitron rounded-2xl hover:bg-neon-green hover:text-black transition-all">
            GET A QUOTE
          </a>
        </div>
      </div>
