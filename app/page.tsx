    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#050805] w-full z-0">
      ...
      <div className="relative z-50 flex -translate-y-80 flex-col items-center px-5">
        ...
        <div className="mt-10 flex flex-col md:flex-row gap-6">
          <Link href="/contact" className="px-10 py-4 bg-[#228B22] text-white font-bold rounded-xl hover:bg-neon-green hover:text-black transition-all transform hover:scale-105 neon-glow">
            START YOUR PROJECT
          </Link>
          <Link href="/services" className="px-10 py-4 glass text-white font-bold rounded-xl hover:bg-white/20 transition-all transform hover:scale-105">
            OUR EXPERTISE
          </Link>
        </div>
      </div>
  ...
  return (
    <div className="relative h-64 flex items-center justify-center">
      {reviews.map((r, i) => (
        ...
        >
          <p className="text-xl md:text-2xl text-white italic text-center max-w-2xl px-6 mb-6">&ldquo;{r.text}&rdquo;</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {SERVICES.map((s) => (
              <div key={s.id} className="glass p-8 rounded-3xl hover:bg-white/5 transition-all group flex flex-col items-center text-center">
                ...
                <Link href="/services" className="text-neon-green text-[10px] font-orbitron font-bold border-b border-neon-green/0 hover:border-neon-green transition-all uppercase tracking-widest">Discover</Link>
              </div>
            ))}
          </div>
        </div>
