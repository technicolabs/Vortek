    ...
    <div className="pt-32 pb-24 px-6 animate-in zoom-in-95 duration-500">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-white/40 max-w-2xl mx-auto text-lg italic">&ldquo;Nurturing your digital presence from seed to skyline with sustainable tech architecture.&rdquo;</p>
        </div>
